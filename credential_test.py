...
class TestUSer (unittest.TestCase):
    ...
    def setUp(self):
        ...
        '''
        self.new_app=Credential("Instagram","Divino","bundi@gmail.com","password")
 ...
 # **********************************First test to check if the app credential details are being instantiated properly****************************************************
    def test_init(self):
        ...
        self.assertEqual(self.new_app.app_username,"Divino")
        self.assertEqual(self.new_app.app_email,"bundi@gmail.com")
...
# **********************************Third test to check if multiple users can be saved into the contact list...****************************************************
    def test_save_multiple_credentials(self):
        ...
        """
        self.new_app.savecredentials()
        test_credential=Credential("facebook","torta","bu@gmail.com","passi")
