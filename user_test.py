...
class TestUser(unittest.TestCase):
    ...
    def setUp(self):
        ...
        '''
        self.new_user = User("Manasseh","0723647389") # create user object
 ...
 # **********************************First test to check if the user details are being instantiated properly****************************************************
    def test_init(self):
        ...
        '''
        self.assertEqual(self.new_user.username,"Manasseh")
        self.assertEqual(self.new_user.password,"0723647389")
...
# **********************************Fourth test to delete users from an user list...****************************************************
    def test_delete_contact(self):
            ...
            '''
            self.new_user.save_user()
            test_user = User("Lenny","700") # new contact
            test_user.save_user()
...
# **********************************Fifth test to find a user from user list...****************************************************
    def test_find_contact_by_number(self):
        ...
        found_user = User.find_by_username("Lenny")
...
#  **********************************Sixth test to check if a usernmae that is been passed actually exists in the list....****************************************************
    def test_contact_exists(self):
        ...
        '''
        self.new_user.save_user()
        test_user=User("Lenny",'700')
        test_user.save_user()

        Username_exists=User.Username_exist("Lenny")
